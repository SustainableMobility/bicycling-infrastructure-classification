...
osm_xml_way_tags = ["osmid","highway", "cycleway", "cycleway:left", "cycleway:right", "lanes", "maxspeed", "name", "oneway", "width", "landuse"]
overpass_endpoint = "https://overpass-api.de/api"
overpass_rate_limit = True
overpass_settings = "[out:json][timeout:{timeout}]{maxsize}"
# overpass_settings = '[out:json][timeout:{timeout}][date:"2022-04-30T23:59:59Z"]{maxsize}'
requests_kwargs = dict()
timeout = 1800
use_cache = True

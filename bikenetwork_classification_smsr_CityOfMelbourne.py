...
G_edges.to_csv('COM_edges_with_bike_infra_class_smsr.csv')
...
ox.io.save_graph_geopackage(G, filepath = 'COM_bikeinfra_smsr.gpkg', directed=True)
...
stats.to_csv('COM_stats_length_by_infra.csv')
